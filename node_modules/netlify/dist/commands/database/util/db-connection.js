...
export async function connectToDatabase(buildDir, urlOverride) {
...
export function detectExistingLocalConnectionString(buildDir) {
...
export async function connectRawClient(buildDir, urlOverride) {
